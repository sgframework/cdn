            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @csrf                
                            <br />
                            <input class="form-control" type="number" class="input" name="ordernumber" placeholder="Material Number" />
                            ...
                            <input class="form-control" type="name" class="input" name="branchname" placeholder="Branch Name" />
