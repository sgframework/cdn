<div class="media">
	...
	@if ($branch->branchname)
        <tbody>
            <tr>
                <td><img class="media-object" alt="{{ $branch->branchname }}" src="{{ asset('image/sgimg.png') }}" style="width:40px; height:40px; float:left; border-radius:50%; margin-right:25px;"></td>
